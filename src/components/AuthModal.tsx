    ...
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="text-center mb-6">
          <div className="w-16 h-16 mx-auto mb-3 rounded-full overflow-hidden border-2 border-purple-primary shadow-glow">
            <img
          ...
          <h2 className="text-2xl font-black text-white">أستاذ أحمد القاضي</h2>
          <p className="text-gray-400 text-sm">منصة الرياضيات الأولى</p>
        </div>

        {/* Tab Switcher */}
        <div className="flex rounded-2xl overflow-hidden glass-light mb-6">
          <button
            className={`flex-1 py-3 font-bold text-sm transition-all ${tab === "login" ? "bg-purple-gradient text-white shadow-glow" : "text-gray-400 hover:text-white"}`}
            onClick={() => setTab("login")}
          >
            تسجيل دخول
          </button>
          <button
            className={`flex-1 py-3 font-bold text-sm transition-all ${tab === "register" ? "bg-purple-gradient text-white shadow-glow" : "text-gray-400 hover:text-white"}`}
